...
# 使用的是Haversine公式计算两个地理坐标点（经纬度）之间的球面距离
...
if __name__ == '__main__':
    ...
    interval = 3600
    # 开始年月
    (start_year, start_month, start_day) = (2023, 10, 1)
    # 结束年月
    (end_year, end_month, end_day) = (2024, 3, 31)
    ...
    # 读取所有数据文件并合并为一个DataFrame
    # 只保留'tpep_pickup_datetime', 'tpep_dropoff_datetime', 'PULocationID', 'DOLocationID'四列
